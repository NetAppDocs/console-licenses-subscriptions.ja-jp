...
=== Cloud Volumes ONTAPライセンスの管理

Cloud Volumes ONTAP ライセンスは、ホームページまたは *Direct licenses* タブで管理できるようになりました。*Marketplace subscriptions* タブを使用して、サブスクリプション情報を表示します。
...
https://docs.netapp.com/us-en/console-setup-admin/task-monitor-cm-operations.html["メール通知の設定方法を学ぶ"^]
...
デジタルウォレットでは、アカウント全体の消費容量と、ライセンスパッケージごとの消費容量が表示されるようになりました。これは、料金がどのように請求されているか、また追加容量を購入する必要があるかどうかを理解するのに役立ちます。
